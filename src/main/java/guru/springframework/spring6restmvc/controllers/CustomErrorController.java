...
public class CustomErrorController {
    ...
    ResponseEntity handleJPAViolations(TransactionSystemException exception) {
        ...
        if (exception.getCause().getCause() instanceof ConstraintViolationException ex) {
            List<Map<String, String>> errors = ex.getConstraintViolations().stream().map(constraintViolation -> {

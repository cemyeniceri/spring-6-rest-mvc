...
public class DrinkListenerKafkaConsumer {
    ...
    public void listenIceCold() {
        System.out.println("I'm listening for iceCold messages");
    ...
    public void listenCold() {
        System.out.println("I'm listening for cold messages");
    ...
    public void listenCool() {
        System.out.println("I'm listening for cool messages");
